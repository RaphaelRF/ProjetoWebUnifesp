...
<body class="corpo">
    ...
    <div class="divform" style="color: black" align="center">
        ...
        <form class="ins_form" action="insere_action.php" method="post">
            <br><br>
        <label class="insira" align="center"><span style="color:yellow">Insira</span><span style="color:white"> o seu jogador</span></label><br><br>
