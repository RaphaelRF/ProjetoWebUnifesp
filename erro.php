    ...
    <div class="top">
        <table width="100%">
           <tr>
            ...
            <h1><span style="color:white">OOPSS.. algo saiu </span><span style="color:yellow">errado.</span></h1> <br>
            <a href="login_form.php"><button class="botao">Voltar</button></a>
            </td>
            <td align="right">
                <img src="img/cvv.jpg" width="83%">
            </td>
