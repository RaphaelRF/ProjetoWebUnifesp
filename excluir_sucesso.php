    ...
    <div class="top">
        <table width="100%">
           <tr>
            ...
            <h1><span style="color:white">Jogador excluído com </span><span style="color:yellow">sucesso!.</span></h1> <br>
            <a href="pagina_restrita.php"><button class="botao">Voltar</button></a>
            </td>
            <td align="right">
                <img src="img/david.jpeg" width="110%">
            </td>
